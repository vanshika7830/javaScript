...
console.log("1"+ 2)       // String Conversion
console.log(1 + "2")      // String Conversion
console.log("1" + "2")    // String Conversion

console.log("1" + 2 +2)   // String Conversion if first is string
console.log(1 + 2 + "2")  // additing of number then string if third is string
console.log(1 + 2 + "2" + 1 + 1 + 1)    //32111
